...
<div class="one-fourth footer-section">
	...
	<ul class="social">
		...
		<li>
			<a href="https://twitter.com/cradavydog" class="twitter" title="Twitter">
				<svg viewBox="0 0 512 512">
		...
		<li>
			<a href="https://www.instagram.com/avalanchedogsrock/" class="instagram" title="Instagram">
				<svg viewBox="0 0 512 512">
					<g>
...
<div class="copyright">
	...
	?>
	<p>&copy; Copyright <?php auto_copyright(2017); ?><a href="/"> <?php bloginfo( 'name' ); ?></a>. All Rights Reserved.</p>
